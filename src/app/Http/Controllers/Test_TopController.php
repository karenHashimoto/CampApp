...
class Test_TopController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('test_top', ['camps1' => $camps1, 'camps2' => $camps2, 'camps3' => $camps3, 'titles1' => $titles1, 'titles2' => $titles2, 'titles3' => $titles3]);
