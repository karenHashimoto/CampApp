...
<body>
    ...
    <div class="reserve_band">プライバシーポリシー</div>
    <div class="wrap_privacy">
        <p>キャンプ女子株式会社 以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
        ...
        <div class="privacy_title">第10条（お問い合わせ窓口）</div>
        <p>本ポリシーに関するお問い合わせは，下記の窓口までお願いいたします。</p>
        <p>住所： 福岡市中央区大名1-3-41-2F<br>
            社名：キャンプ女子株式会社<br>
            担当部署：キャンシェルジュ<br>
            Eメールアドレス：doko@camjyo.com</p>
